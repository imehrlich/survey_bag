...
The graph below indicates bikers were substantially more satisfied with the added rubber curbs than the painted lines.
```{r, echo=FALSE}
# subsets with response frequencies
